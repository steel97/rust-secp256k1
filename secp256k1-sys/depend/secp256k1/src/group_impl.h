...
{
    rustsecp256k1_v0_4_1_fe x2, x3, c;
    r->x = *x;
    rustsecp256k1_v0_4_1_fe_sqr(&x2, x);
    rustsecp256k1_v0_4_1_fe_mul(&x3, x, &x2);
    r->infinity = 0;
    rustsecp256k1_v0_4_1_fe_set_int(&c, 7);
    rustsecp256k1_v0_4_1_fe_add(&c, &x3);
    return rustsecp256k1_v0_4_1_fe_sqrt(&r->y, &c);
}
/* end */
...
static int rustsecp256k1_v0_4_1_gej_eq_x_var(const rustsecp256k1_v0_4_1_fe *x, const rustsecp256k1_v0_4_1_gej *a)
{
    ...
    rustsecp256k1_v0_4_1_fe_sqr(&r, &a->z);
    rustsecp256k1_v0_4_1_fe_mul(&r, &r, x);
    r2 = a->x;
    rustsecp256k1_v0_4_1_fe_normalize_weak(&r2);
...
static int rustsecp256k1_v0_4_1_ge_is_valid_var(const rustsecp256k1_v0_4_1_ge *a)
{
    ...
    rustsecp256k1_v0_4_1_fe_sqr(&x3, &a->x);
    rustsecp256k1_v0_4_1_fe_mul(&x3, &x3, &a->x);
    rustsecp256k1_v0_4_1_fe_add(&x3, &rustsecp256k1_v0_4_1_fe_const_b);
...
static void rustsecp256k1_v0_4_1_gej_add_var(rustsecp256k1_v0_4_1_gej *r, const rustsecp256k1_v0_4_1_gej *a, const rustsecp256k1_v0_4_1_gej *b, rustsecp256k1_v0_4_1_fe *rzr)
{
    ...
    rustsecp256k1_v0_4_1_fe_mul(&s1, &a->y, &z22);
    rustsecp256k1_v0_4_1_fe_mul(&s1, &s1, &b->z);
    rustsecp256k1_v0_4_1_fe_mul(&s2, &b->y, &z12);
    rustsecp256k1_v0_4_1_fe_mul(&s2, &s2, &a->z);
    rustsecp256k1_v0_4_1_fe_negate(&h, &u1, 1);
    rustsecp256k1_v0_4_1_fe_add(&h, &u2);
    rustsecp256k1_v0_4_1_fe_negate(&i, &s1, 1);
    rustsecp256k1_v0_4_1_fe_add(&i, &s2);
    ...
    r->x = t;
    rustsecp256k1_v0_4_1_fe_mul_int(&r->x, 2);
    rustsecp256k1_v0_4_1_fe_add(&r->x, &h3);
    rustsecp256k1_v0_4_1_fe_negate(&r->x, &r->x, 3);
    rustsecp256k1_v0_4_1_fe_add(&r->x, &i2);
    rustsecp256k1_v0_4_1_fe_negate(&r->y, &r->x, 5);
    rustsecp256k1_v0_4_1_fe_add(&r->y, &t);
    rustsecp256k1_v0_4_1_fe_mul(&r->y, &r->y, &i);
    rustsecp256k1_v0_4_1_fe_mul(&h3, &h3, &s1);
    rustsecp256k1_v0_4_1_fe_negate(&h3, &h3, 1);
...
static void rustsecp256k1_v0_4_1_gej_add_ge_var(rustsecp256k1_v0_4_1_gej *r, const rustsecp256k1_v0_4_1_gej *a, const rustsecp256k1_v0_4_1_ge *b, rustsecp256k1_v0_4_1_fe *rzr)
{
    ...
    rustsecp256k1_v0_4_1_fe_sqr(&z12, &a->z);
    u1 = a->x;
    rustsecp256k1_v0_4_1_fe_normalize_weak(&u1);
    rustsecp256k1_v0_4_1_fe_mul(&u2, &b->x, &z12);
    s1 = a->y;
    rustsecp256k1_v0_4_1_fe_normalize_weak(&s1);
    rustsecp256k1_v0_4_1_fe_mul(&s2, &b->y, &z12);
    rustsecp256k1_v0_4_1_fe_mul(&s2, &s2, &a->z);
    rustsecp256k1_v0_4_1_fe_negate(&h, &u1, 1);
    rustsecp256k1_v0_4_1_fe_add(&h, &u2);
...
static void rustsecp256k1_v0_4_1_gej_add_zinv_var(rustsecp256k1_v0_4_1_gej *r, const rustsecp256k1_v0_4_1_gej *a, const rustsecp256k1_v0_4_1_ge *b, const rustsecp256k1_v0_4_1_fe *bzinv)
{
    ...
    rustsecp256k1_v0_4_1_fe_normalize_weak(&s1);
    rustsecp256k1_v0_4_1_fe_mul(&s2, &b->y, &z12);
    rustsecp256k1_v0_4_1_fe_mul(&s2, &s2, &az);
    rustsecp256k1_v0_4_1_fe_negate(&h, &u1, 1);
    rustsecp256k1_v0_4_1_fe_add(&h, &u2);
    rustsecp256k1_v0_4_1_fe_negate(&i, &s1, 1);
    rustsecp256k1_v0_4_1_fe_add(&i, &s2);
    ...
    rustsecp256k1_v0_4_1_fe_mul(&h3, &h, &h2);
    r->z = a->z;
    rustsecp256k1_v0_4_1_fe_mul(&r->z, &r->z, &h);
    rustsecp256k1_v0_4_1_fe_mul(&t, &u1, &h2);
    r->x = t;
    rustsecp256k1_v0_4_1_fe_mul_int(&r->x, 2);
    rustsecp256k1_v0_4_1_fe_add(&r->x, &h3);
...
static void rustsecp256k1_v0_4_1_gej_add_ge(rustsecp256k1_v0_4_1_gej *r, const rustsecp256k1_v0_4_1_gej *a, const rustsecp256k1_v0_4_1_ge *b)
{
    ...
    u1 = a->x;
    rustsecp256k1_v0_4_1_fe_normalize_weak(&u1);  /* u1 = U1 = X1*Z2^2 (1) */
    rustsecp256k1_v0_4_1_fe_mul(&u2, &b->x, &zz); /* u2 = U2 = X2*Z1^2 (1) */
    s1 = a->y;
    rustsecp256k1_v0_4_1_fe_normalize_weak(&s1);  /* s1 = S1 = Y1*Z2^3 (1) */
    rustsecp256k1_v0_4_1_fe_mul(&s2, &b->y, &zz); /* s2 = Y2*Z1^2 (1) */
    rustsecp256k1_v0_4_1_fe_mul(&s2, &s2, &a->z); /* s2 = S2 = Y2*Z1^3 (1) */
    t = u1;
    rustsecp256k1_v0_4_1_fe_add(&t, &u2); /* t = T = U1+U2 (2) */
    m = s1;
    rustsecp256k1_v0_4_1_fe_add(&m, &s2);           /* m = M = S1+S2 (2) */
