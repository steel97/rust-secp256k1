...
#include <stdint.h>
     ...
     *  the rustsecp256k1_v0_4_1_generator_serialize_*.
     *
    ...
    SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_4_1_generator_parse(
        ...
        rustsecp256k1_v0_4_1_generator *commit,
    ...
    SECP256K1_API int rustsecp256k1_v0_4_1_generator_serialize(
        ...
        const rustsecp256k1_v0_4_1_generator *commit) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
    ...
    SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_4_1_generator_generate(
        ...
        const unsigned char *seed32) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
    ...
    SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_4_1_generator_generate_blinded(
        ...
        const unsigned char *blind32) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4);
