...
#include <stdint.h>
     ...
     */
    extern const rustsecp256k1_v0_4_1_generator *rustsecp256k1_v0_4_1_generator_h;

    /** Parse a 33-byte commitment into a commitment object.
     *
     *  Returns: 1 if input contains a valid commitment.
     *  Args: ctx:      a rustsecp256k1_v0_4_1 context object.
    ...
    SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_4_1_pedersen_commitment_parse(
        ...
        const unsigned char *input) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
    ...
    SECP256K1_API int rustsecp256k1_v0_4_1_pedersen_commitment_serialize(
        ...
        const rustsecp256k1_v0_4_1_pedersen_commitment *commit) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);

    /** Initialize a context for usage with Pedersen commitments. */
    void rustsecp256k1_v0_4_1_pedersen_context_initialize(rustsecp256k1_v0_4_1_context *ctx);
     ...
     *
     *  Blinding factors can be generated and verified in the same way as rustsecp256k1_v0_4_1 private keys for ECDSA.
     */
    SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_4_1_pedersen_commit(
        ...
        uint64_t value,
        const rustsecp256k1_v0_4_1_generator *gen) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(5);
     ...
     */
    SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_4_1_pedersen_commitment_sum(
        const rustsecp256k1_v0_4_1_context *ctx,
        rustsecp256k1_v0_4_1_pedersen_commitment *sum_out,
     ...
     *
     * A pedersen commitment is xG + vA where G and A are generators for the rustsecp256k1_v0_4_1 group and x is a blinding factor,
    ...
    SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_4_1_pedersen_verify_tally(
        ...
        size_t ncnt) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(4);
    ...
    /** Initialize a context for usage with Pedersen commitments. */
    void rustsecp256k1_v0_4_1_rangeproof_context_initialize(rustsecp256k1_v0_4_1_context *ctx);
    ...
    SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_4_1_rangeproof_verify(
        ...
        const rustsecp256k1_v0_4_1_generator *gen) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4) SECP256K1_ARG_NONNULL(5) SECP256K1_ARG_NONNULL(9);
    ...
    SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_4_1_rangeproof_sign(
        ...
        const unsigned char *extra_commit,
        size_t extra_commit_len,
        const rustsecp256k1_v0_4_1_generator *gen) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(5) SECP256K1_ARG_NONNULL(6) SECP256K1_ARG_NONNULL(7) SECP256K1_ARG_NONNULL(15);
    ...
    SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_4_1_rangeproof_info(
        ...
        uint64_t *max_value,
        const unsigned char *proof,
        size_t plen) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4) SECP256K1_ARG_NONNULL(5);
